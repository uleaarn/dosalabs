...
export const InHome = () => {
  ...
  return (
    <div className="bg-white min-h-screen pb-32 font-sans">
          ...
          >
            ...
            <div className="block md:hidden mb-8">
              <div className="aspect-[4/3] rounded-card overflow-hidden bg-grayLight border border-grayBorder shadow-lg">
                <img 
                  src="https://firebasestorage.googleapis.com/v0/b/dosalabs-95e1b.firebasestorage.app/o/Menu%2015.jpeg?alt=media&token=fbc41002-653d-49d5-84d0-7b8fdbea0b0d" 
      ...
      {/* Birthday Special Section - Updated with Image Split Layout */}
      <section className="max-w-7xl mx-auto px-6 py-12 mb-16 relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 bg-graySubtle rounded-card border border-grayBorder overflow-hidden">
          <div className="h-80 lg:h-auto relative">
            <img 
              ...
              className="w-full h-full object-cover" 
              alt="Kids Dosa Lab Session" 
            />
            <div className="absolute inset-0 bg-black/10" />
            <div className="absolute top-8 left-8">
              <span className="bg-accent text-white px-4 py-1.5 rounded-full text-xs font-bold uppercase tracking-widest shadow-xl">JUNIOR LAB</span>
            </div>
          </div>
          
          <div className="p-10 md:p-16 lg:p-20 relative">
            <div className="absolute top-0 right-0 w-64 h-64 bg-accent/5 rounded-full blur-3xl -translate-y-1/2 translate-x-1/2" />
            <span className="text-xs font-bold uppercase tracking-[0.2em] text-accent mb-6 block">Special Events</span>
            ...
            <div className="flex flex-col gap-6">
              <button 
                ...
                className="w-full bg-ink text-white px-12 py-5 rounded-full font-bold text-lg hover:shadow-2xl transition-all"
              >
                Plan a Birthday Dosa Party
              </button>
              <p className="text-[10px] text-grayMedium uppercase tracking-widest font-bold text-center">
                Requires active adult supervision. Kid-safe tools only.
              </p>
            </div>
          </div>
        </div>
