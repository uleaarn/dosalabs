...
const DISHES = [
  {
    ...
    image: 'https://firebasestorage.googleapis.com/v0/b/dosalabs-95e1b.firebasestorage.app/o/Dosa%20Mastery%20Lab.jpg?alt=media&token=d3da3ed1-89c5-46db-85dc-ffde7658daec',
  },
  {
    name: 'Idli',
    color: '#BF9264',
    eyebrow: 'GRIND • FERMENT • STEAM',
    image: 'https://firebasestorage.googleapis.com/v0/b/dosalabs-95e1b.firebasestorage.app/o/Idli.jpg?alt=media&token=521359d9-1915-4609-9d30-bda3eb011fe8',
  },
  {
    name: 'Chutney',
    color: '#BF9264',
    eyebrow: 'ROAST • BLEND • TEMPER',
    image: 'https://firebasestorage.googleapis.com/v0/b/dosalabs-95e1b.firebasestorage.app/o/Chutney.jpg?alt=media&token=7e266d7c-111c-406d-a8b1-ecceee59b71d',
  },
  {
    name: 'Sambar',
    color: '#BF9264',
    eyebrow: 'AROMATICS • LENTILS • TEMPER',
    image: 'https://firebasestorage.googleapis.com/v0/b/dosalabs-95e1b.firebasestorage.app/o/Sambar.jpg?alt=media&token=67495081-e0a1-4328-b8e2-47001841c6a5',
  },
  {
    name: 'Medu Vada',
    color: '#BF9264',
    eyebrow: 'SOAK • GRIND • SHAPE • FRY',
    image: 'https://firebasestorage.googleapis.com/v0/b/dosalabs-95e1b.firebasestorage.app/o/menduvada.jpg?alt=media&token=5f8d4a14-e043-4559-ae7b-b79e55d5d34b',
  }
];
          ...
          >
            <Link to="/classes/dosa-mastery-lab" className="block h-full relative overflow-hidden rounded-card border border-grayBorder bg-white shadow-xl hover:shadow-[0_40px_80px_-20px_rgba(0,0,0,0.15)] transition-all duration-500">
              <div className="aspect-[16/10] lg:aspect-auto lg:h-[600px] overflow-hidden">
                <img 
                  src="https://firebasestorage.googleapis.com/v0/b/dosalabs-95e1b.firebasestorage.app/o/Dosa%20Mastery%20Lab.jpg?alt=media&token=d3da3ed1-89c5-46db-85dc-ffde7658daec" 
            ...
            <motion.div whileHover={{ x: 10 }} className="group">
              <Link to="/classes/kids-dosa-lab" className="flex flex-col sm:flex-row bg-graySubtle rounded-card border border-grayBorder overflow-hidden h-full sm:h-64 hover:bg-white hover:shadow-2xl transition-all duration-300">
                <div className="sm:w-2/5 relative">
                  <img 
                    src="https://firebasestorage.googleapis.com/v0/b/dosalabs-95e1b.firebasestorage.app/o/KidsDosaclass.png?alt=media&token=49fc2031-c4f9-4f01-a25f-4cabb99bfb58" 
