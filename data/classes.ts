...
const classesData: ClassItem[] = [
  ...
  {
    "id": "c8",
    "name": "Medu Vada Mastery",
    "price": 69,
    "type": "online",
    "slug": "medu-vada-mastery",
    "category": "adults",
    "tagline": "The Golden Crunch. Master the Aeration.",
    "description": "Medu Vada is all about the batter. Learn the exact soaking time and the high-speed aeration technique required to get that legendary light-as-air interior and shatteringly crisp exterior without soaking up oil.",
    "duration": "90 mins",
    "masteryList": [
      "The 'Float Test' for batter aeration",
      "Shaping the perfect doughnut with wet hands",
      "Oil temperature management (350°F sweet spot)",
      "Preventing oil absorption during frying",
      "The secret to that signature curry leaf and ginger aroma"
    ],
    "includedList": [
      "Live step-by-step shaping drill",
      "Vada Troubleshooting Cheat Sheet",
      "Classic & Vegetable Vada recipes",
      "Full class recording",
      "Dosalabs Library access"
    ],
    "ingredients": [
      "1 cup whole skinless Urad Dal",
      "Fresh curry leaves & Ginger",
    ...
    "equipment": [
      "Powerful blender with small jar",
      "Large mixing bowl for hand-aeration",
      "Deep frying pan (Kadai)",
      "Slotted spoon",
      "Small plastic sheet for beginners"
    ],
    "goodToKnow": [
      "Requires 4 hours of pre-soaking dal before class.",
      "Frying safety is a priority in this lab.",
      "Allergens: Lentils (Gluten-free)."
    ]
  },
  {
    "id": "c3",
